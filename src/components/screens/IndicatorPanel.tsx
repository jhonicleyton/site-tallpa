    ...
    <div className="p-4 sm:p-5">
      ...
      <div className="grid gap-3 lg:grid-cols-[1.1fr_1fr]">
        <div className="rounded-2xl border border-line bg-bg-1/60 p-3.5">
          <div className="mb-3 text-[9px] font-semibold uppercase tracking-[0.14em] text-gray-500">
          ...
          <div className="flex h-[110px] items-end gap-2">
            {meses.map((v, i) => (
              <div key={i} className="flex flex-1 flex-col items-center gap-1.5">
                ...
                />
                <span className="font-mono text-[8px] text-gray-600">{v}</span>
              </div>
            ))}
          </div>
          <div className="mt-3 flex items-center gap-2 border-t border-line pt-3">
            ...
            <span className="text-[10px] text-gray-500">8 meses de série acumulada</span>
          </div>
        </div>
